      ...
      <div className="dashboard-layout">
        ...
        <div className="flex-col-lg" style={{ position: 'sticky', top: '24px' }}>
          ...
          <div className="flex-col">
            <StatCard 
              value={stats.stat1} 
              label={role === 'company' ? 'Active Job Postings' : role === 'admin' ? 'Total Users' : 'Applications Sent'} 
              isLoading={isLoading} 
            />
            <StatCard 
              value={stats.stat2} 
              label={role === 'company' ? 'Total Applicants' : role === 'admin' ? 'Total Companies' : 'Open Jobs'} 
              isLoading={isLoading} 
            />
          </div>
