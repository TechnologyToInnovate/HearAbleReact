...
import FormInput from '../components/common/FormInput'; // 🚨 NEW
    ...
    <div className="page-container-wide">
      ...
      {isLoading ? <p className="text-secondary">Loading...</p> : resumes.length > 0 ? (
        ...
        <EmptyState 
          ...
          message="Click the upload button above to add your first resume."
        />
      )}

      {/* 🚨 REFACTORED UPLOAD MODAL FORM */}
      <Modal
        isOpen={isUploadModalOpen}
        onClose={() => { setIsUploadModalOpen(false); setSelectedFile(null); setNewTitle(''); }}
      ...
      <Modal
        ...
        height="85vh"
      >
        <div style={{ flex: 1, backgroundColor: '#525659', margin: '-24px', overflow: 'hidden' }}>
          <iframe 
